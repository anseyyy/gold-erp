    ...
    return (
        <div className="w-full space-y-5 transition-colors">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="h-11 w-full border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/60 px-3 text-sm text-slate-800 dark:text-slate-100 outline-none transition placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-indigo-300 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900"
                            />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="0.00"
                                    className="h-11 w-full border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/60 px-3 pr-16 text-sm font-medium text-slate-800 dark:text-slate-100 outline-none transition placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-indigo-300 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900"
                                />

                                <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-xs font-semibold text-indigo-500 dark:text-indigo-400">
                                    USDT
                                </span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="0.00"
                                    className="h-11 w-full border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/60 px-3 pr-14 text-sm font-medium text-slate-800 dark:text-slate-100 outline-none transition placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-indigo-300 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900"
                                />

                                <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-xs font-semibold text-slate-400 dark:text-slate-500">
                                    IDR
                                </span>
                            </div>
                        </div>
            ...
            <div className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-xl overflow-hidden">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="0.00"
                                className="h-11 w-full border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/60 px-3 pr-16 text-sm outline-none transition placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-indigo-300 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900 text-slate-800 dark:text-slate-100"
                            />
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="0.00"
                                className="h-11 w-full border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/60 px-3 pr-14 text-sm outline-none transition placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-indigo-300 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900 text-slate-800 dark:text-slate-100"
                            />
                ...
                {/* Results */}
                <div className="grid border-t border-slate-100 dark:border-slate-800 sm:grid-cols-3">

                    {/* Buy Cost */}
                    <div className="border-b border-slate-100 dark:border-slate-800 px-5 py-5 sm:border-b-0 sm:border-r">
                    ...
                    <div
                        className={`px-5 py-5 ${
                            profit >= 0
                                ...
                                : "bg-rose-50/40 dark:bg-rose-950/40"
                        }`}
                    >
