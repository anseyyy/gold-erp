  ...
  return (
    <div className="space-y-6 ">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">Podiyana Sell Account</h1>
          <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">
            Podiyana customer gold sales with real-time rate calculations.
          </p>
        </div>
        <div className="flex items-center gap-2">
          <Link href="/spreadsheet?module=podiyana-sell">
            <Button
              type="button"
              variant="outline"
              size="sm"
            ...
            >
              View Podiyana Sell Spreadsheet Page
            </Button>
          </Link>
